import classes from "./Cart01.module.css"
        ...
        <div className={classes.cartContainer}>
            ...
            <div className={classes.cart}>
                <div className={classes.cartContent}>
                    <div className={"pointer d-flex flex-column " + classes.cartImage} onClick={modalControl}>
                        {newItem && <h6 className={classes.newItem}>New</h6>}
                        <img className="rounded align-self-center" src={cartImage} alt="" />
                        <h5 className="text-center align-self-center ">{item.title}</h5>
                    </div>
                    <div className="py-2 px-0  px-md-2 d-flex flex-column align-items-center">
                        <div ref={ignoredRef} className={"my-3 " + classes.selectDiv}>
                            <SelectedInput selFunc={(parms) => setQuantity(parms)} name="quantity" value={quantity} options={item.quantity} />
                        </div>
