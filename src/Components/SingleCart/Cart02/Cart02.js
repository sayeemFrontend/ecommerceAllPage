import classes from "./Cart02.module.css"
        ...
        <div className={classes.cartContainer}>
            ...
            <div className={classes.cart}>
                ...
                {amountButton ? <QuantityFun /> : (
                    <div className={" py-2 " + classes.btnContainer}>
                        <Button onClicked={() => setAmountButton(true)} title="Add to Cart" />
                    </div>
                )}
            </div>
        </div>
