      ...
      <div className={classes.productView}>
         <div className="row">
            <div className="col-sm-12 col-md-12 col-lg-5">
               ...
               <div className={classes.imgSlider + " d-flex d-md-none justify-content-around"}>
            ...
            <div className=" col-sm-12 col-md-12 col-lg-7">
               ...
               <div className={classes.btnContainer}>
                  ...
                  <div className={classes.addtoBag + " ms-0 ms-md-0 ms-lg-3 mt-4 mt-md-4 mt-lg-0 fs-12 brPrimary-1 bgPrimary-1 cWhite d-flex justify-content-center align-content-center"}>
